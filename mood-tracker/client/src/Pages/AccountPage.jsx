  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const userResponse = await fetch('https://full-stack-projects-yvmx.onrender.com/user/profile', {
          headers: {
        ...
        const moodDataResponse = await fetch(`https://full-stack-projects-yvmx.onrender.com/journal/mood-data?range=${timeRange}`, {
          headers: {
            'Authorization': `Bearer ${token}`
          }
        });
        ...
        if (moodDataResult.length >= 7) {
          ...
          const moodFrequencyResponse = await fetch(`https://full-stack-projects-yvmx.onrender.com/journal/mood-frequency?range=${timeRange}`, {
            headers: {
              'Authorization': `Bearer ${token}`
            }
          });
